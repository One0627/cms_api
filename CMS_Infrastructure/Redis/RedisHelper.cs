...
namespace CMS_Infrastructure.Redis
{
    ...
    public class RedisCommon : IRedisCommon
    {
        ...
        //redis数据库连接字符串
        private readonly string  _conn = "192.168.8.105:6379,password=admin";
        ...
        public ConnectionMultiplexer CacheConnection
        {
            get
            {
                ...
                {
                    _logger.LogError("RedisHelper->CacheConnection 出错\r\n" + ex.ToString());
                    return null;
                }
                return connection;
            }
        ...
        public string StringGet(string key)
        {
            ...
            {
                _logger.LogError("RedisHelper->StringGet 出错\r\n" + ex.ToString());
                return null;
            }
        }
        ...
        public string[] StringGetMany(string[] keyStrs)
        {
            ...
            {
                _logger.LogError("RedisHelper->StringGetMany 出错\r\n" + ex.ToString());
                return null;
            }
        }
        /// <summary>
        ...
        /// <returns></returns>
        public string HashGet(RedisKey key,RedisValue hashField)
        {
            return CacheRedis.HashGet(key, hashField);
        }
        /// <summary>
        /// hash是否存在
        /// </summary>
        ...
        {
            return CacheRedis.HashExists(key, hashField);
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            return CacheRedis.HashSet(key, hashField, value);
        }
        /// <summary>
        /// 删除hasekey
        /// </summary>
        ...
        public void SetExpire(string key,TimeSpan time)
        {
            CacheRedis.KeyExpire(key, time);
        }
        #endregion
